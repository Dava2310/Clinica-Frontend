...
const Item = ({step, panelCurrent}:PropsItem) => {
    return (
      <div className={`rounded-full border-2 border-gray-400 px-4 py-2  font-medium shadow-sm ${panelCurrent == step ?'bg-gray-400 text-white' : 'bg-gray-300 text-gray-500'}`}>{step}</div>
    )
}
